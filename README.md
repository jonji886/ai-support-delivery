...
- **非开发者**：建议依次阅读[30 秒了解项目](#30-秒了解项目)、[解决什么问题](#解决什么问题)、[当前能力边界](#当前能力边界)和[当前评测结果](#当前评测结果)；需要深入了解方案时，再查看[AI 产品判断与取舍](#ai-产品判断与取舍)、[场景化 Skill 设计](#场景化-skill-如何封装企业-ai-能力)和[已知限制与生产化方向](#已知限制与生产化方向)。
- **开发者**：建议从[快速开始](#快速开始)进入，再查看[业务流程](#业务流程)、[API 示例](#api-示例)、[测试与验收](#测试与验收)、[项目结构](#项目结构)和[评测与 Badcase](#评测与-badcase-质量闭环)。
